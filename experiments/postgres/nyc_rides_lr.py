...
def nyc_rides_lr(batch_sizes):

    inferdb = InferDB('nyc_rides', LinearRegression(), 'regression', 1, False, True, 'trip_duration', NYC_Featurizer('deep'))
    sqlmodel = SQLmodel('nyc_rides', LinearRegression(), 'regression', True, 'trip_duration', NYC_Featurizer('deep'))
    pgml = PGML('nyc_rides', LinearRegression(), 'regression', True, 'trip_duration', NYC_Featurizer('deep'))
